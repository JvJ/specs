...
(def frame-delay-ms 100)
(def num-frames 100)
(def max-success-delay-ms 90)
(def min-fail-delay-ms 110)
(def max-fail-delay-ms 190)
(def min-rand-variance-ms 10)
(def max-rand-variance-ms 110)
;; LEFTOFF: How to determine expected range of values
;; from random sample??
